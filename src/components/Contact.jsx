            ...
            <section className="py-6" >
                <div className="grid max-w-6xl grid-cols-1 px-6 mx-auto lg:px-8 md:grid-cols-2 md:divide-x">
                    ...
                    <form method="POST" action="https://getform.io/f/11375a38-161b-4b72-a4c5-d534b152c9a9" className="flex flex-col py-6 space-y-6 md:py-0 md:px-6 ng-untouched ng-pristine ng-valid">
                        ...
                        <button type="submit" className="self-center border-2 px-8 py-3 text-lg rounded focus:ring hover:ring focus:ring-opacity-75 focus:ring-pink-600 hover:bg-pink-600">Submit</button>
                    </form>
                </div>
            </section>
        </div>
